  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
              ...
              <nav className="flex-1 px-2 py-4 bg-white space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? ' text-white bg-gray-900' : 'text-gray-900 hover:bg-gray-700 hover:text-white',
                      'group flex items-center px-2 py-2 text-sm font-medium rounded-md',
                    )}
                  >
                    <item.icon
                      className={classNames(
                        item.current ? 'text-white' : 'text-gray-900 group-hover:text-gray-300',
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className="relative z-10 flex-shrink-0 flex h-16 bg-gray-900 shadow">
          <button
